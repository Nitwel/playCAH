<template>
    <div id="game">
        ...
        <div class="points">
            ...
            >
                <span v-if="zar === user.name" class="zar material-icons">star_rate</span>
                <span v-if="store.state.name == user.name" class="material-icons">person</span>
                <span class="name"> {{user.name}} </span>
                {{ user.points }} points.
            </span>
        </div>
        <div class="table">
            <div class="slots" v-if="blackCard">
                <div v-for="(user, pos) in users" :key="user.name" class="user-slot">
                    <Card
                    ...
                    >
                        ...
                        <span v-if="user.placed && !isRevealed(pos)" class="questionmark abs">?</span>
                        <span v-if="isRevealed(pos)" class="revealed" v-html="revealed[pos][i]" />
                ...
                <div v-if="!isZar && !allPlaced && !playerPlaced" class="user-slot">
                    <Effect
            ...
            .user-slot {
                ...
                .card {
                    ...
                    .winner {
                        ...
                        &.scaleSelect-enter,
                        &.scaleSelect-leave-to {
                            transform: translate(-50%, -50%) scale(0.1);
                        }
                        &.scaleSelect-enter-to,
                        &.scaleSelect-leave {
